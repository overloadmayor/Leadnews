...
<head>
    ...
    <title>黑马头条</title>
    <!-- 引入样式文件 -->
    <link rel="stylesheet" href="https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/vant/2.12.10/index.min.css">
    <!-- 页面样式 -->
...
<script src="https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/vue/2.7.16/vue.min.js">
</script>
<script src="https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/vant/2.12.10/vant.min.js"></script>
<!-- 引入 Axios 的 JS 文件 -->
